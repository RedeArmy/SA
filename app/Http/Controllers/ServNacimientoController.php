    ...
    public function Imprimir(Request $re){
        ...
        if($valor_cui_valido === true){
            ...
            if($existencia_cui == false){
                ...
                $id_departamento = json_decode($objeto->obtenerDepartamento($json_persona[0]['id_muni']),true)[0];
                ...
                $persona_info = [
                    ...
                    'fechaNacimientoPadre' => strtotime($persona_p['created_at']),
                    'paisPadre' => '1',
                    'departamentoPadre' => '',
                    ...
                    'fechaNacimientoMadre' => strtotime($persona_m['created_at']),
                    'paisMadre' => '1',
                    'departamentoMadre' => '',
